...
public final class GwtEntryPoint implements ApplicationBooterProvider, EntryPoint {
    ...
    private static void registerServiceProviders() {
        ...
        register(dev.webfx.platform.visibility.spi.VisibilityProvider.class, dev.webfx.platform.visibility.spi.impl.elemental2.Elemental2VisibilityProvider::new);
